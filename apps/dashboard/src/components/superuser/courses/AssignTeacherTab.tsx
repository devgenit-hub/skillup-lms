          ...
          {availableTeachers.map((teacher) => (
            ...
            >
              ...
              <button
                ...
                className="px-4 py-2 bg-dark-blue text-white rounded-lg hover:bg-dark-blue/90 transition-colors font-medium flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
