...
const steps = [
  {
    ...
    description: 'প্রথমে সাইন-আপ করে আপনার লার্নিং প্রোফাইলটি অ্যাক্টিভেট করুন।',
  },
  {
    icon: '/UI/LandingPage/search.svg',
    title: 'কোর্স বাছাই',
    description: 'আপনার স্কিল ডেভেলপমেন্টের জন্য সঠিক কোর্সটি খুঁজে নিন।',
  },
  {
    icon: '/UI/LandingPage/check.svg',
    title: 'ভর্তি নিশ্চিতকরণ',
    description: 'সহজ পেমেন্ট মেথডের মাধ্যমে আপনার সিটটি বুক করে ফেলুন।',
  },
  {
    icon: '/UI/LandingPage/dashboard.svg',
    title: 'কোর্স শুরু',
    description: 'ড্যাশবোর্ড থেকে যেকোনো সময়, যেকোনো স্থান থেকে শিখতে শুরু করুন।',
  },
];
