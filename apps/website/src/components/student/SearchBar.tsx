...
export default function SearchBar() {
  return (
    <InputGroup className="h-full bg-card backdrop-blur-xl rounded-3xl shadow-lg border border-border px-4 lg:px-5 transition-all duration-300 hover:shadow-xl focus-within:shadow-xl focus-within:border-vibrant-blue/30">
      <InputGroupInput
