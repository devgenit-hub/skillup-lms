...
export default function DashboardContent({ children }: DashboardContentProps) {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-background via-background to-muted/20">
      <div className="mx-auto p-4 xl:p-6 h-screen flex flex-col gap-4 xl:gap-6 max-w-360">
        {/* Top Navigation Bar */}
          ...
          <div className="xl:col-span-9">
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="xl:hidden p-2 rounded-xl bg-card/80 backdrop-blur-xl shadow-md border border-border hover:bg-card transition-all duration-300 active:scale-95"
        ...
        {/* Main Content Area */}
        <div className="flex-1 grid grid-cols-1 xl:grid-cols-12 gap-4 xl:gap-5 min-h-0">
          {/* Desktop Sidebar - Hidden on mobile */}
          <aside className="hidden xl:block xl:col-span-2 h-full overflow-hidden">
          ...
          <aside className="hidden xl:block xl:col-span-3 h-full overflow-hidden">
