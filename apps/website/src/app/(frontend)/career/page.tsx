    ...
    <div className="min-h-screen bg-linear-to-br from-background via-background to-muted/20 flex items-center justify-center px-4 py-20">
      <div className="max-w-4xl w-full">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-indigo-500/10 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-cyan-500/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
        </div>

        {/* Main content card */}
        <div className="relative bg-card backdrop-blur-xl rounded-3xl shadow-2xl border border-border p-8 md:p-12 transition-all duration-300 hover:shadow-indigo-500/20">
          {/* Icon header */}
          <div className="flex justify-center mb-8">
            <div className="relative">
              <div className="absolute inset-0 bg-indigo-600/20 rounded-full blur-xl animate-pulse"></div>
              <div className="relative p-6 rounded-full bg-linear-to-br from-indigo-600 to-purple-600 shadow-lg">
          ...
          <div className="flex justify-center">
            <Link
              href="/"
              className="group inline-flex items-center gap-2 px-6 py-3 rounded-full bg-linear-to-r from-indigo-600 to-purple-600 text-white font-semibold shadow-lg hover:shadow-indigo-600/50 transition-all duration-300 hover:scale-105"
            >
        ...
        <div className="mt-8 h-1 w-full bg-linear-to-r from-transparent via-indigo-600 to-transparent rounded-full"></div>
      </div>
    </div>
  );
}
